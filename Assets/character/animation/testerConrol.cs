...
public class testerConrol : MonoBehaviour
{
    ...
    {
        // Log
        Debug.Log("Run : testerControl");

        // 初期値
        this.testerAnimator = GetComponent<Animator>(); // testerのアニメーターを獲得
        this.startPosition = transform.position; // testerのスタート位置を獲得
        this.direction = this.startPosition;
        this.targetPosition = this.startPosition;
        this.playersSearchIndex = Vector2Int.zero;
        this.playersAreaIndex = Vector2Int.zero;
        this.startPlayerIndex = Vector2Int.zero;
    ...
    private Vector3 charaControl(Vector3 position){
        ...
        // アニメーションの切り替え
        testerAnimator.SetInteger("num", animationNum);
